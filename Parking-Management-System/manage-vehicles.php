<?php
	...
	include('counters/invehicles-count.php');
	include('test.php');
		...
		if($count_parkings < $count) {
			...
			if ($query) {
				echo "<script>
					swal({
						title: 'Success!',
						text: 'Parked Your Vehicle Successfully!',
						icon: 'success',
						button: 'OK',
						color: '#00FF00',
					});
			...
			swal({
				title: 'Error!',
				text: 'Couldn\'t Park Your Vehicle, Parking Full!',
				icon: 'error',
				button: 'OK',
				color: '#FF0000',
			});
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="MH 03 EJ 6523" id="vehreno" name="vehreno" required>
								</div>


								<div class="form-group">
									<label>Vehicle's Company Name</label>
									<input type="text" class="form-control" placeholder="Hero Honda" id="vehcomp" name="vehcomp" required>
								</div>
