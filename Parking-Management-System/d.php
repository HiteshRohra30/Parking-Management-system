<style>
<div class="dialog" title="My Alert">
    <p>Blah blah blah</p>
</div>
</style>
<?php
	...
	include('counters/current-parkingCount.php');
	include('test.php');
						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="MH 03 EG 9154" id="vehreno" name="vehreno" required>
								</div>


								<div class="form-group">
									<label>Vehicle's Company Name</label>
									<input type="text" class="form-control" placeholder="Honda" id="vehcomp" name="vehcomp" required>
								</div>
